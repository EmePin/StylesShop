...
<div align="center">
  ...
  <h3 align="center">StylesShop-README</h3>

  <p align="center">
    Readme del proyecto de un sitio web para un ecommerce con paypal.
    <br />
    <a href="https://github.com/EmePin/StylesShop"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://emepin.github.io/StylesShop/index.html">View Demo</a>
    ·
    <a href="https://github.com/EmePin/StylesShop/issues">Report Bug</a>
    ·
    <a href="https://github.com/EmePin/StylesShop/issues">Request Feature</a>
  </p>
</div>
...
Para obtener una copia local de este repositorio se puede clonar o [descargar](https://github.com/EmePin/StylesShop/archive/refs/heads/main.zip).
### Prerequisites

```sh
  git clone https://github.com/EmePin/StylesShop.git
```

-Abrir el archivo `index.html` en [vsc](https://code.visualstudio.com/) con la extensión [LiveServer](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer)
...
3.  Reemplazar en el head de carrito.html el client-id
      ...
      ```sh
            <script
                src="https://www.paypal.com/sdk jsclient-id=CHANGE_YOUR_ID_CLIENT&currency=MXN">
            </script>
      ```
...
| Example Color | ![#666666](https://via.placeholder.com/10/666666?text=+) #666666 |
...
See the [open issues](https://github.com/EmePin/StylesShop/issues) for a full list of proposed features (and known issues).
...
Distributed under the MIT License. See [LICENSE](https://github.com/EmePin/StylesShop/blob/main/LICENSE.txt) for more information.
...
-   **Project Link** : [StylesShop](https://github.com/EmePin/StylesShop)
...
[license-url]: https://github.com/EmePin/StylesShop/blob/master/LICENSE.txt
